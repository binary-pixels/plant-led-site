          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {products
              ...
              .map((p) => (
                ...
                >
                  <div className="w-16 h-16 rounded-lg bg-linear-to-br from-purple-100 to-emerald-50 flex items-center justify-center shrink-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {products
              ...
              .map((p) => (
                ...
                >
                  <div className="w-16 h-16 rounded-lg bg-linear-to-br from-blue-100 to-cyan-50 flex items-center justify-center shrink-0">
